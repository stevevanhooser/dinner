...
A running table of dinner ideas to draw from when building the rotation.
Keep adding here — we'll pull from this list into the 14-day rotation later.

| Idea                               | Type     | Notes                          |
|------------------------------------|----------|--------------------------------|
| Spaghetti and Meatballs            | Homemade |                                |
| Bolognaise                         | Homemade | A kid favorite                 |
| Lasagna                            | Homemade |                                |
| Chicken, Green Beans, and Potatoes | Homemade |                                |
| Tacos                              | Homemade |                                |
...
- **Homemade** — cooked at home
- **Grill** — cooked outside on the grill
- **Takeout** — picked up
- **Go Out** — eat at a restaurant

Add new ideas as you think of them, then pull from this list into the 14-day
rotation.
